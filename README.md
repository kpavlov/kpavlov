...
val me = developer {
    ...
    tech("Kotlin", "Koog", "Java", "Spring", "Swift", "AI", "iOS")
    links {
...
- [quarkiverse/quarkus-langchain4j](https://github.com/quarkiverse/quarkus-langchain4j) ([1.1.3](https://github.com/quarkiverse/quarkus-langchain4j/releases/tag/1.1.3), 5 days ago) - Quarkus Langchain4j extension
