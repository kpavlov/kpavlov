...
- [quarkiverse/quarkus-langchain4j](https://github.com/quarkiverse/quarkus-langchain4j) ([1.9.1](https://github.com/quarkiverse/quarkus-langchain4j/releases/tag/1.9.1), 1 day ago) - Quarkus Langchain4j extension
- [quarkiverse/quarkus-mcp-server](https://github.com/quarkiverse/quarkus-mcp-server) ([1.12.0](https://github.com/quarkiverse/quarkus-mcp-server/releases/tag/1.12.0), 2 days ago) - This extension enables developers to implement the MCP server features easily.
...
- [langchain4j/langchain4j](https://github.com/langchain4j/langchain4j) ([1.13.0](https://github.com/langchain4j/langchain4j/releases/tag/1.13.0), 2 weeks ago) - LangChain4j is an idiomatic, open-source Java library for building LLM-powered applications on the JVM. It offers a unified API over popular LLM providers and vector stores, and makes implementing tool calling (including MCP support), agents and RAG easy. It integrates seamlessly with enterprise Java frameworks like Quarkus and Spring Boot.
- [Kotlin/kotlinx-schema](https://github.com/Kotlin/kotlinx-schema) ([v0.5.0](https://github.com/Kotlin/kotlinx-schema/releases/tag/v0.5.0), 2 weeks ago) - Kotlin Multiplatform library that generates JSON Schemas from your methods and classes both at compile-time via Kotlin Symbol Processing(KSP) and at runtime via reflection or kotlinx.serialization.
- [mokksy/ai-mocks](https://github.com/mokksy/ai-mocks) ([v0.8.0](https://github.com/mokksy/ai-mocks/releases/tag/v0.8.0), 3 weeks ago) - AI-Mocks is a Kotlin-based mock server toolkit that brings service virtualization to both HTTP/SSE and LLM APIs — think WireMock meets local OpenAI/Anthropic/Gemini/A2A testing, but with real streaming and Server-Sent Events support.
