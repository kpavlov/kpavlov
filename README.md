...
- [quarkiverse/quarkus-mcp-server](https://github.com/quarkiverse/quarkus-mcp-server) ([1.7.1](https://github.com/quarkiverse/quarkus-mcp-server/releases/tag/1.7.1), 2 days ago) - This extension enables developers to implement the MCP server features easily.
- [quarkiverse/quarkus-langchain4j](https://github.com/quarkiverse/quarkus-langchain4j) ([1.4.0.CR2](https://github.com/quarkiverse/quarkus-langchain4j/releases/tag/1.4.0.CR2), 2 days ago) - Quarkus Langchain4j extension
