...
- [langchain4j/langchain4j](https://github.com/langchain4j/langchain4j) ([1.9.1](https://github.com/langchain4j/langchain4j/releases/tag/1.9.1), 6 days ago) - LangChain4j is an open-source Java library that simplifies the integration of LLMs into Java applications through a unified API, providing access to popular LLMs and vector databases. It makes implementing RAG, tool calling (including support for MCP), and agents easy. LangChain4j integrates seamlessly with various enterprise Java frameworks.
...
- [quarkiverse/quarkus-mcp-server](https://github.com/quarkiverse/quarkus-mcp-server) ([1.8.0](https://github.com/quarkiverse/quarkus-mcp-server/releases/tag/1.8.0), 1 week ago) - This extension enables developers to implement the MCP server features easily.
