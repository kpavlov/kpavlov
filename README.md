...
- [Kotlin/kotlinx-schema](https://github.com/Kotlin/kotlinx-schema) ([v0.3.1](https://github.com/Kotlin/kotlinx-schema/releases/tag/v0.3.1), 4 days ago) - Kotlin Multiplatform library that generates JSON Schemas from your methods and classes both at compile-time via Kotlin Symbol Processing(KSP) and at runtime via reflection or kotlinx.serialization.
- [quarkiverse/quarkus-langchain4j](https://github.com/quarkiverse/quarkus-langchain4j) ([1.7.1](https://github.com/quarkiverse/quarkus-langchain4j/releases/tag/1.7.1), 5 days ago) - Quarkus Langchain4j extension
- [quarkiverse/quarkus-mcp-server](https://github.com/quarkiverse/quarkus-mcp-server) ([1.10.0](https://github.com/quarkiverse/quarkus-mcp-server/releases/tag/1.10.0), 6 days ago) - This extension enables developers to implement the MCP server features easily.
