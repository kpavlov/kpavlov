...
- [Kotlin/kotlinx-schema](https://github.com/Kotlin/kotlinx-schema) ([v0.4.1](https://github.com/Kotlin/kotlinx-schema/releases/tag/v0.4.1), 2 days ago) - Kotlin Multiplatform library that generates JSON Schemas from your methods and classes both at compile-time via Kotlin Symbol Processing(KSP) and at runtime via reflection or kotlinx.serialization.
- [quarkiverse/quarkus-langchain4j](https://github.com/quarkiverse/quarkus-langchain4j) ([1.8.0.CR2](https://github.com/quarkiverse/quarkus-langchain4j/releases/tag/1.8.0.CR2), 2 days ago) - Quarkus Langchain4j extension
