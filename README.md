...
- [quarkiverse/quarkus-langchain4j](https://github.com/quarkiverse/quarkus-langchain4j) ([1.2.4](https://github.com/quarkiverse/quarkus-langchain4j/releases/tag/1.2.4), 2 days ago) - Quarkus Langchain4j extension
- [mokksy/mokksy](https://github.com/mokksy/mokksy) ([v0.8.0](https://github.com/mokksy/mokksy/releases/tag/v0.8.0), 4 days ago) - Mokksy is a mock HTTP server built with Kotlin and Ktor
...
- [modelcontextprotocol/kotlin-sdk](https://github.com/modelcontextprotocol/kotlin-sdk) ([0.8.4](https://github.com/modelcontextprotocol/kotlin-sdk/releases/tag/0.8.4), 2 weeks ago) - The official Kotlin SDK for Model Context Protocol servers and clients. Maintained in collaboration with JetBrains

#### 📜 My recent blog posts

- [Mokksy: A Mock Server That Actually Streams — and Why Your AI App Needs Integration Tests](https://kpavlov.me/blog/mokksy/) (4 days ago)
