...
- [Kotlin/kotlinx-schema](https://github.com/Kotlin/kotlinx-schema) - Kotlin Multiplatform library that generates JSON Schemas from your methods and classes at compile time and at runtime via reflection using Kotlin Symbol Processing (KSP) (3 weeks ago)

#### 🔭 Latest releases I've contributed to

- [quarkiverse/quarkus-langchain4j](https://github.com/quarkiverse/quarkus-langchain4j) ([1.5.0](https://github.com/quarkiverse/quarkus-langchain4j/releases/tag/1.5.0), 4 days ago) - Quarkus Langchain4j extension
